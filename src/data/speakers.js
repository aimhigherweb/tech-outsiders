...
const speakers = [
    {
        ...
        bio: (
            <Fragment>
                <p>Amy is a freelance developer, <a href="https://aimhigherwebdesign.com.au/" target="_blank">starting her own business</a>, working with other freelancers and learning everything she can about the web. She’s been a freelancer on the side for 4 years, and most recently worked at an agency in Subiaco.</p>
                <p>Amy also spends her time helping out as a co-organiser for <a href="https://fenders.co/" target="_blank">Fenders</a> (a community group of front-end developers in Perth), other community events (such as Perth Web Girls) and works as an evangelist for YOW! Conference. She <a href="https://amygoestoperth.com.au/" target="_blank">blogs in her spare time</a> (about tech, the web and life), and volunteers as a reviewer for the Fringe World Festival in Perth. Amy has also started <a href="https://thefreelance.guide/" target="_blank">The Freelance Guide</a> to help other freelancers.</p>
            </Fragment>
        ),
        mentoring: (
    ...
    },
    {
        ...
        mentoring: (
            <p>I am a Mentor and Role Model in the <a href="http:/www.techgirlsaresuperheroes.org/" target="_blank" rel="nofollow">Tech Girls are Superheroes</a> Program. I actively encourage young women and girls to pursue careers in tech and STEM.</p>
        ),
        social: {
            linkedin: 'https:/au.linkedin.com/in/michellesandford',
            twitter: 'https:/twitter.com/msandfor',
            facebook: 'https:/www.facebook.com/michellesandfordSpeaker/',
            instagram: 'https:/www.instagram.com/msandfor/',
            youtube: 'https:/www.youtube.com/user/msandfor',
            website: 'http:/michellesandford.com/',
            featured: [
                'linkedin',
                'twitter',
                'website',
    ...
    },
    {
        ...
        social: {
            ...
            instagram: 'http:/instagram.com/mingjohanson',
            website: 'https://mingjohanson.com.au/',
            youtube: 'https:/www.youtube.com/user/MingSocialNerd',
            featured: [
                'twitter',
                'linkedin',
                'facebook'
